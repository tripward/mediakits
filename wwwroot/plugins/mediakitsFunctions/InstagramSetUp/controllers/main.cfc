<cfcomponent displayname="FacebookSetUpMainController" persistent="false" accessors="true" output="false" extends="plugins.mediakitsFunctions.common.controllers.basecontroller">
		...
		<cfproperty name="InstagramService">
...
/*WriteDump(var=rc,top=2,label='goo', abort=true);*/
	...
	<cffunction name="persist" >
		<cftry>
			...
			<cfset variables.InstagramService.persist(influenceraccountid="#rc.influenceraccountid#", InstagramUserName=rc.InstagramUserName) />
	      ...
	      <cfcatch type="any" >
			<cfdump var="#cfcatch#" label="cfcatch in InstagramUserName persist" abort="false"  />
