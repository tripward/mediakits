...
<cfoutput>
	<div class="container-mediakitsFunctions container">

		<!--- PRIMARY NAV --->
		<div class="row">
			<div class="col-md-12">
				<div class="navbar navbar-mediakitsFunctions">
					<div class="navbar-header">
						<a class="plugin-brand" href="#buildURL('admin:main')#">
							#rc.$.esapiEncode('html', rc.pc.getPackage())#
						</a>
					</div><!--- /.navbar-header --->
		...
		<div class="row">
			<cfif rc.action contains 'admin:main'>
				...
				<!--- SUB-NAV --->
				<div class="col-md-3">
					<ul class="nav nav-stacked mediakitsFunctions-sidenav">
						<li class="<cfif rc.action eq 'admin:main.default'>active</cfif>">
							<a href="#buildURL('admin:main')#"><i class="icon-home"></i> Home</a>
						</li>
	...
	</div><!--- /.container-mediakitsFunctions --->
</cfoutput>
