...
<cfoutput>
	<plugin>
		...
		<!--
			...
			custom ORM components., /plugins/mediakitsFunctions/influencer/model/beans/
		-->
		<ormCFCLocation>/plugins/mediakitsFunctions/common/model/beans</ormCFCLocation>
		...
		<eventHandlers>
			...
			<eventHandler
					...
					component="model.handlers.mediakitsFunctions"
					persist="false" />
