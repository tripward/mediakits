		...
		<div class="col-md-6">
			...
			<form role="form" method="post">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="fname" value="#local.registration.getFName()#" />
				</div>
				<div class="form-group">
					<label for="lname">Last Name</label>
					<input type="text" class="form-control" name="lname" value="#local.registration.getLName()#" />
				</div>
