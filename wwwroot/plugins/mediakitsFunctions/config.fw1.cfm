...
*/
	...
	variables.framework.package = 'mediakitsFunctions';
	...
	// the 'action' defaults to your packageNameAction, (e.g., 'mediakitsFunctionsaction') you may want to update this to something else.
