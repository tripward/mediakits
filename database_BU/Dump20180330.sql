...
--
-- Table structure for table `custom_awards`
--

DROP TABLE IF EXISTS `custom_awards`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `custom_awards` (
  `PresentedBy` varchar(1000) DEFAULT '',
  `PresentedDate` datetime DEFAULT NULL,
  `name` varchar(50) NOT NULL DEFAULT '',
  `description` varchar(1000) DEFAULT '',
  `datemodified` datetime DEFAULT NULL,
  `awardid` char(35) NOT NULL DEFAULT '',
  `keywords` varchar(255) DEFAULT '',
  `datecreated` datetime DEFAULT NULL,
  `influencerProfileid` char(35) DEFAULT '',
  PRIMARY KEY (`awardid`),
  KEY `IX_custom_awards_influencerProfileid` (`influencerProfileid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `custom_awards`
--

LOCK TABLES `custom_awards` WRITE;
/*!40000 ALTER TABLE `custom_awards` DISABLE KEYS */;
INSERT INTO `custom_awards` VALUES ('icf','2018-02-08 00:00:00','my award','cxvbxcbvxcxcbccxcccv  fgh f fd h',NULL,'88392940-8002-7D59-D5A333E28BA18D32',NULL,NULL,'D3187245-8002-7D59-D5A27230A5F9FBC2'),('icf','2018-02-08 00:00:00','NFCM2018','fvdf dsfvdfvsdvsv',NULL,'893989BE-8002-7D59-D5A415BAE57ACE53',NULL,NULL,'D3187245-8002-7D59-D5A27230A5F9FBC2');
/*!40000 ALTER TABLE `custom_awards` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `custom_categories` VALUES ('C7E2AFBD-8002-7D59-D5A03301CC983436','cat1','cat1','2017-11-21 14:54:07','cat1','2017-11-21 14:54:07'),('C7E2B088-8002-7D59-D5A100586FFC25B2','cat2','cat2','2017-11-21 14:54:07','cat2','2017-11-21 14:54:07'),('C7E2B14C-8002-7D59-D5AD2D7D98727072','cat23','cat23','2017-11-21 14:54:07','cat23','2017-11-21 14:54:07'),('C7E2B207-8002-7D59-D5A577F8A7F5A7E7','cat3','cat3','2017-11-21 14:54:07','cat3','2017-11-21 14:54:07');
/*!40000 ALTER TABLE `custom_categories` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `custom_conferences`
--

DROP TABLE IF EXISTS `custom_conferences`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `custom_conferences` (
  ...
  `description` varchar(1000) DEFAULT '',
  `datemodified` datetime DEFAULT NULL,
  `conferenceid` char(35) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `custom_conferences`
--

LOCK TABLES `custom_conferences` WRITE;
/*!40000 ALTER TABLE `custom_conferences` DISABLE KEYS */;
INSERT INTO `custom_conferences` VALUES ('','my c onf','fer fee   efeff',NULL,'8C27FD2C-8002-7D59-D5AA981434101FD8',NULL,NULL,'2018-03-14 20:04:22','2018-04-25 00:00:00');
/*!40000 ALTER TABLE `custom_conferences` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `custom_demographics`
--

DROP TABLE IF EXISTS `custom_demographics`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `custom_demographics` (
  `demographicid` char(35) NOT NULL DEFAULT '',
  `name` varchar(50) NOT NULL DEFAULT '',
  `description` varchar(1000) DEFAULT '',
  `datemodified` datetime DEFAULT NULL,
  `keywords` varchar(255) DEFAULT '',
...
--
-- Dumping data for table `custom_demographics`
--

LOCK TABLES `custom_demographics` WRITE;
/*!40000 ALTER TABLE `custom_demographics` DISABLE KEYS */;
INSERT INTO `custom_demographics` VALUES ('C69E67D3-8002-7D59-D5AC921A69029799','Male 18-25','dumb and broke and easily taken advantage of','2017-11-21 14:18:41','dumb broke','2017-11-21 14:18:41'),('C69E6888-8002-7D59-D5A71BB2C370F544','Male 26-39','not dumb, but still not smart, still easy','2017-11-21 14:18:42','disposiable income','2017-11-21 14:18:42'),('C69E6939-8002-7D59-D5A676302DFD172D','Male 40-59','already married, but looking','2017-11-21 14:18:42','saving for retirement','2017-11-21 14:18:42'),('C69E69EC-8002-7D59-D5ACDCFFE266F5FD','Male 60+','Bingo anyone?','2017-11-21 14:18:42','retired','2017-11-21 14:18:42');
/*!40000 ALTER TABLE `custom_demographics` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `custom_influenceraccounts` VALUES (NULL,'Virginia','michele','queen@werwards.com',NULL,NULL,'ward',NULL,'42893134-8002-7D59-D5A2AF1A43010886','407 Monticello Dr',NULL,NULL,NULL,NULL,NULL,'22556',NULL,1,'11111','Virginia','2018-02-11 12:56:09','2018-02-11 12:56:08'),(NULL,'AL','Patrick','patricktisdel@outlook.com',NULL,NULL,'Tisdel',NULL,'AB1DAD05-8002-7D59-D5AF159EB86BAD57','407 monticello dr',NULL,NULL,NULL,NULL,NULL,'22556',NULL,1,'111111','AL','2018-03-30 08:24:56','2018-03-30 08:24:54'),(NULL,'AL','Andrea','andrea@khourypr.com',NULL,NULL,'Khoury',NULL,'AB405ED2-8002-7D59-D5A1A33E1474C474','407 monticello dr',NULL,NULL,NULL,NULL,NULL,'22556',NULL,1,'11111111','AL','2018-03-30 08:28:42','2018-03-30 08:28:41'),(NULL,'Virginia','trip','king@werwards.com',NULL,NULL,'ward',NULL,'D318534A-8002-7D59-D5A5506803232882','407 monticello dr',NULL,NULL,NULL,NULL,NULL,'22556',NULL,1,'1111','Virginia','2018-02-04 09:41:45','2018-02-04 09:41:44');
...
CREATE TABLE `custom_influencerprofiles` (
  `mediakitTemplateID` int(10) DEFAULT '1',
  `instagramAccessCode` varchar(1000) DEFAULT '',
  `instagramAccessCodeSetUpdate` datetime DEFAULT NULL,
  ...
  `facebookLongLivedAccessTokenType` varchar(1000) DEFAULT '',
  ...
  `twitterFollowersCount` int(10) DEFAULT '0',
  `facebookBusinesspageLink` varchar(255) DEFAULT '',
  `pintrestLastUpdate` datetime DEFAULT NULL,
  `facebookLongLivedAccessToken` varchar(1000) DEFAULT '',
  `datemodified` datetime DEFAULT NULL,
  ...
  `BaseInfluencerRadius` varchar(255) DEFAULT '',
  ...
  `pintrestFollowersCount` int(10) DEFAULT '0',
  `facebookShortLivedAccessTokenSetDate` datetime DEFAULT NULL,
  `instagramFollowersCount` int(10) DEFAULT '0',
  `twitterLastUpdate` datetime DEFAULT NULL,
  `facebookShortLivedAccessToken` varchar(1000) DEFAULT '',
  `blogURL` varchar(100) DEFAULT '',
  `FacebookID` varchar(50) DEFAULT '',
  `facebookLongLivedAccessTokenExpiresIn` varchar(50) DEFAULT '',
  `facebookFriendsCount` int(10) DEFAULT '0',
  ...
  `instagramAccessToken` varchar(1000) DEFAULT '',
  `instagramAccessTokenSetUpdate` datetime DEFAULT NULL,
  `twitterFollowedByCount` int(10) DEFAULT '0',
  `twitterFollowingCount` int(10) DEFAULT '0',
  `pintrestFollowingCount` int(10) DEFAULT '0',
  `twitterResponse` varchar(3000) DEFAULT '',
  `facebookResponse` varchar(3000) DEFAULT '',
  `PintrestResponse` varchar(3000) DEFAULT '',
  `instagramResponse` varchar(3000) DEFAULT '',
...
INSERT INTO `custom_influencerprofiles` VALUES (1,NULL,NULL,'42893134-8002-7D59-D5A2AF1A43010886',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,'2018-02-11 12:56:08',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'428954B6-8002-7D59-D5A5C067A0E828DB',NULL,NULL,NULL,NULL,0,NULL,0,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,'2018-02-11 12:56:08',NULL,'',NULL,0,0,0,'','','','',NULL,NULL),(1,'',NULL,'AB1DAD05-8002-7D59-D5AF159EB86BAD57',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,'2018-03-30 08:24:56',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'AB1DF94A-8002-7D59-D5A9B47C94F2DCC7',NULL,NULL,NULL,NULL,0,NULL,0,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,'2018-03-30 08:24:56',NULL,NULL,NULL,0,0,0,NULL,NULL,NULL,NULL,NULL,NULL),(1,'',NULL,'AB405ED2-8002-7D59-D5A1A33E1474C474',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,'2018-03-30 08:28:42',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'AB40710D-8002-7D59-D5A4E5E45A44542C',NULL,NULL,NULL,NULL,0,NULL,0,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,'2018-03-30 08:28:42',NULL,NULL,NULL,0,0,0,NULL,NULL,NULL,NULL,NULL,NULL),(1,NULL,NULL,'D318534A-8002-7D59-D5A5506803232882','0902D905FD7AC555118735B294D8DBAE','2018-02-20 16:09:16','bearer','0902D905FD7AC555118735B294D8DBAE',NULL,'0902D905FD7AC555118735B294D8DBAE',NULL,0,NULL,NULL,'EAAcrAkgFkjYBAFPNHmF5Nuf6ZBNa8ZC8vP4ZAgW7pEo1kBA2UOD03Oyxj6EFAPBBMsY6dgquN5M4gwq6pWPS9ZBbS8xRLmKUB6VCGwACg2L249sJUaH5KSWnCDO3QufMdItyTcGslcxkRTJsiLTK7ZBGZAby5ZCtZCwZD','2018-03-29 17:50:48','@tripward','king@werwards.com',NULL,'trip.ward',NULL,'100',NULL,'D3187245-8002-7D59-D5A27230A5F9FBC2','Description',NULL,'0902D905FD7AC555118735B294D8DBAE',NULL,0,'2018-02-20 16:09:16',0,'2018-02-24 09:50:16','EAAcrAkgFkjYBAPQCXoQTaq7yTMEnuzVjc4xGjL5pMtQuZBvVN8FlMIHd2Bm2J8rghZB8HxmBaVdbMCRFIELwLARsKBjNZAbDzISCK707tS1TTFcj5cbxQJ8GHqrzQBP7f6NShVHurgUPIrwT0BxMjo7LqVD1VnwtMZAlHGNUbgp91Qt91CA0DSJ57THExNVX6zpk0qaZC2QZDZD','blogURL','10156087191719596','5098979',0,NULL,'22556','webURL','Keywords','2018-02-04 09:41:45','ward5593',NULL,NULL,0,0,0,'',NULL,NULL,NULL,NULL,'2018-03-29 00:00:00');
/*!40000 ALTER TABLE `custom_influencerprofiles` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `custom_influencerprofiletocategories`
--

DROP TABLE IF EXISTS `custom_influencerprofiletocategories`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `custom_influencerprofiletocategories` (
  `siteid` varchar(25) DEFAULT '',
  `InfluencerProfileID` char(35) DEFAULT '',
  `categoryid` char(35) DEFAULT '',
  `InfluencerProfileToCategoryid` char(35) NOT NULL DEFAULT '',
  `userid` char(35) DEFAULT '',
  PRIMARY KEY (`InfluencerProfileToCategoryid`),
  KEY `IX_custom_InfluencerProfileToCategories_siteid` (`siteid`),
  KEY `IX_custom_InfluencerProfileToCategories_InfluencerProfileID` (`InfluencerProfileID`),
  KEY `IX_custom_InfluencerProfileToCategories_categoryid` (`categoryid`),
  KEY `IX_custom_InfluencerProfileToCategories_userid` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `custom_influencerprofiletocategories`
--

LOCK TABLES `custom_influencerprofiletocategories` WRITE;
/*!40000 ALTER TABLE `custom_influencerprofiletocategories` DISABLE KEYS */;
INSERT INTO `custom_influencerprofiletocategories` VALUES ('','D3187245-8002-7D59-D5A27230A5F9FBC2','C7E2AFBD-8002-7D59-D5A03301CC983436','74AA9487-8002-7D59-D5AC5BC8556DAF1E','');
/*!40000 ALTER TABLE `custom_influencerprofiletocategories` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `custom_influencerprofiletodemographics`
--

DROP TABLE IF EXISTS `custom_influencerprofiletodemographics`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `custom_influencerprofiletodemographics` (
  `siteid` varchar(25) DEFAULT '',
  `InfluencerProfileID` char(35) DEFAULT '',
  `InfluencerProfileToDemographicsid` char(35) NOT NULL DEFAULT '',
  `demographicID` char(35) DEFAULT '',
  `userid` char(35) DEFAULT '',
  PRIMARY KEY (`InfluencerProfileToDemographicsid`),
  KEY `IX_custom_InfluencerProfileToDemographics_siteid` (`siteid`),
  KEY `IX_custom_InfluencerProfileToDemographics_InfluencerProfileID` (`InfluencerProfileID`),
  KEY `IX_custom_InfluencerProfileToDemographics_demographicID` (`demographicID`),
  KEY `IX_custom_InfluencerProfileToDemographics_userid` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `custom_influencerprofiletodemographics`
--

LOCK TABLES `custom_influencerprofiletodemographics` WRITE;
/*!40000 ALTER TABLE `custom_influencerprofiletodemographics` DISABLE KEYS */;
INSERT INTO `custom_influencerprofiletodemographics` VALUES ('','D3187245-8002-7D59-D5A27230A5F9FBC2','74AA92DB-8002-7D59-D5AD9D1BBEB9D161','C69E67D3-8002-7D59-D5AC921A69029799','');
/*!40000 ALTER TABLE `custom_influencerprofiletodemographics` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `custom_influencersubscriptions` VALUES (NULL,NULL,'Premiere',NULL,NULL,1,1,'Im a good trial','4D941CA9-8002-7D59-D5A0B2C98DB44CDE',1,NULL,'Short paid trial',1,3),(NULL,NULL,'Standard',NULL,NULL,1,1,'Willing to see it over time','4D941D26-8002-7D59-D5A654F6255A5E14',5,NULL,'Long enough to',1,6),(NULL,NULL,'Premiere',NULL,NULL,1,1,'Im all in','4D941D9E-8002-7D59-D5ABBA4DD6C28AEA',10,NULL,'Im all in',1,12);
...
INSERT INTO `custom_influencersubscriptiontoaccount` VALUES (NULL,NULL,NULL,'4D941CA9-8002-7D59-D5A0B2C98DB44CDE',NULL,NULL,NULL,1,'42893134-8002-7D59-D5A2AF1A43010886',NULL,'42893E44-8002-7D59-D5A1DACEAEBAB1DE',NULL,NULL,NULL),(NULL,NULL,NULL,'4D941D9E-8002-7D59-D5ABBA4DD6C28AEA',NULL,NULL,NULL,1,'AB1DAD05-8002-7D59-D5AF159EB86BAD57',NULL,'AB1DB4E5-8002-7D59-D5A6FDB071BE1046',NULL,NULL,NULL),(NULL,NULL,NULL,'4D941D9E-8002-7D59-D5ABBA4DD6C28AEA',NULL,NULL,NULL,1,'AB405ED2-8002-7D59-D5A1A33E1474C474',NULL,'AB40622E-8002-7D59-D5A2727E0C6338E9',NULL,NULL,NULL),(NULL,NULL,NULL,'4D941CA9-8002-7D59-D5A0B2C98DB44CDE',NULL,NULL,NULL,1,'D318534A-8002-7D59-D5A5506803232882',NULL,'D31859CC-8002-7D59-D5A0F6588B02A6A1',NULL,NULL,NULL);
/*!40000 ALTER TABLE `custom_influencersubscriptiontoaccount` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `custom_presslinks`
--

DROP TABLE IF EXISTS `custom_presslinks`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `custom_presslinks` (
  `publication` varchar(1000) DEFAULT '',
  `presslinkid` char(35) NOT NULL DEFAULT '',
  `name` varchar(50) NOT NULL DEFAULT '',
  `description` varchar(1000) DEFAULT '',
  `datemodified` datetime DEFAULT NULL,
...
--
-- Dumping data for table `custom_presslinks`
--

LOCK TABLES `custom_presslinks` WRITE;
/*!40000 ALTER TABLE `custom_presslinks` DISABLE KEYS */;
INSERT INTO `custom_presslinks` VALUES (NULL,'8AF74968-8002-7D59-D5A7ECBB1EE278AE','my presslink','my presslink  desc',NULL,NULL,NULL,NULL),('news','8B23C66C-8002-7D59-D5A431EB83F2CFBE','my presslink 2','my presslink  desc',NULL,'2018-03-12 00:00:00',NULL,NULL);
/*!40000 ALTER TABLE `custom_presslinks` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tclustercommands` VALUES ('8BD2C967-8002-7D59-D5A1161E0010415A','24B80542-8002-7D59-D5A87769EF119E08','getBean(\'settingsManager\').getSite(\'mediakits\').getCacheFactory(name=\'data\').purge(key=\'influencerProfileD3187245-8002-7D59-D5A27230A5F9FBC2\')','2018-03-29 17:49:54'),('8BD2C97D-8002-7D59-D5AA71040168A40D','571AE3BD-8002-7D59-D5ADD251365FD37C','getBean(\'settingsManager\').getSite(\'mediakits\').getCacheFactory(name=\'data\').purge(key=\'influencerProfileD3187245-8002-7D59-D5A27230A5F9FBC2\')','2018-03-29 17:49:54'),('8BD2C9A9-8002-7D59-D5A85A07B99CA6C4','58A418AA-8002-7D59-D5A81F71C1C31376','getBean(\'settingsManager\').getSite(\'mediakits\').getCacheFactory(name=\'data\').purge(key=\'influencerProfileD3187245-8002-7D59-D5A27230A5F9FBC2\')','2018-03-29 17:49:54'),('8BDB0205-8002-7D59-D5A9793173C778B1','24B80542-8002-7D59-D5A87769EF119E08','getBean(\'settingsManager\').getSite(\'mediakits\').getCacheFactory(name=\'data\').purge(key=\'influencerProfileD3187245-8002-7D59-D5A27230A5F9FBC2\')','2018-03-29 17:50:48'),('8BDB0223-8002-7D59-D5A31DD12E47033F','571AE3BD-8002-7D59-D5ADD251365FD37C','getBean(\'settingsManager\').getSite(\'mediakits\').getCacheFactory(name=\'data\').purge(key=\'influencerProfileD3187245-8002-7D59-D5A27230A5F9FBC2\')','2018-03-29 17:50:48'),('8BDB023A-8002-7D59-D5AFA4D4B3A6DF13','58A418AA-8002-7D59-D5A81F71C1C31376','getBean(\'settingsManager\').getSite(\'mediakits\').getCacheFactory(name=\'data\').purge(key=\'influencerProfileD3187245-8002-7D59-D5A27230A5F9FBC2\')','2018-03-29 17:50:48'),('8C0841DD-8002-7D59-D5A517184886ECA7','24B80542-8002-7D59-D5A87769EF119E08','getBean(\'settingsManager\').remoteReload()','2018-03-29 17:55:44'),('8C0841F4-8002-7D59-D5A54A0FFD3FFCB5','571AE3BD-8002-7D59-D5ADD251365FD37C','getBean(\'settingsManager\').remoteReload()','2018-03-29 17:55:44'),('8C084212-8002-7D59-D5A49E0BCEBDC5C4','58A418AA-8002-7D59-D5A81F71C1C31376','getBean(\'settingsManager\').remoteReload()','2018-03-29 17:55:44'),('AB1DF5CB-8002-7D59-D5AA9C51F591593F','8B4F88AD-8002-7D59-D5A92454CC64DB93','getBean(\'settingsManager\').getSite(\'mediakits\').getCacheFactory(name=\'data\').purge(key=\
000000000000000001',NULL),('mediakits','C768E772-B4DA-EEC0-A4B3EDFF5EF34AEA','00000000000000000000000000000000001',NULL),('mediakits','D5BA078C-8002-7D59-D5A80C90A2EB0160','D5B2EBD1-8002-7D59-D5A3153792A7B24E','infuencer-profile/edit-twitter-connection'),('mediakits','E29DBCD5-8002-7D59-D5AD2C9A6FCAA223','E2900224-8002-7D59-D5A0A949AFA7E831','privacy-policy'),('mediakits','E2A919D6-8002-7D59-D5A09F6E0CB5B9DC','E2A1618E-8002-7D59-D5AFBA1B371F37FE','terms-of-service'),('mediakits','E6ABB4C9-8002-7D59-D5A2084F5ED5CD7D','E6A26097-8002-7D59-D5ADB80CED1C7859','infuencer-profile/edit-instagram-connection'),('mediakits','EA101994-8002-7D59-D5AA31ABC2E751D3','EA0A3198-8002-7D59-D5AE99DFA50E107F','infuencer-profile/generate-media-kit');
...
INSERT INTO `tcontentobjects` VALUES ('057A8B6B-8002-7D59-D5A7BA6F37C88E28','03DC396D-C36A-423B-888A0DAB06A3F5C1','FacebookSetup','0469E2CB-8002-7D59-D5AE4474C059AD5B','Facebook Setup Form',1,'mediakits',2,'{\"object\":\"FacebookSetup\",\"objectname\":\"Facebook Setup Form\",\"objecticonclass\":\"mi-leaf\",\"inited\":true}'),('2CF9C97E-8002-7D59-D5ADF5AB555B557F','7CC1C644-A0AF-49E3-A3AD835E82FB0188','influencerprofile','8C11B342-8002-7D59-D5A2C28158D55B86','influencerprofile',1,'mediakits',2,'{\"object\":\"influencerprofile\",\"objecticonclass\":\"mi-leaf\",\"objectname\":\"\",\"render\":\"server\"}'),('2D078EA7-8002-7D59-D5AAF1C1ABCF1C08','10737041-D1E8-4FFB-824469F3CF138B4D','influencerSocialMediaStats','8C11B342-8002-7D59-D5A2C28158D55B86','Profile Social Media Stats',1,'mediakits',3,'{\"object\":\"influencerSocialMediaStats\",\"objectname\":\"Profile Social Media Stats\",\"objecticonclass\":\"mi-leaf\"}'),('2D078EA7-8002-7D59-D5AAF1C1ABCF1C08','7CC1C644-A0AF-49E3-A3AD835E82FB0188','influencerprofile','8C11B342-8002-7D59-D5A2C28158D55B86','influencerprofile',1,'mediakits',2,'{\"object\":\"influencerprofile\",\"objecticonclass\":\"mi-leaf\",\"objectname\":\"\",\"render\":\"server\"}'),('30411681-8002-7D59-D5A3BFC8AE251210','7CC1C644-A0AF-49E3-A3AD835E82FB0188','influencerprofile','8C11B342-8002-7D59-D5A2C28158D55B86','influencerprofile',1,'mediakits',2,'{\"object\":\"influencerprofile\",\"objecticonclass\":\"mi-leaf\",\"objectname\":\"\",\"render\":\"server\"}'),('31A2BFDF-8002-7D59-D5A38CA58EADBD96','7CC1C644-A0AF-49E3-A3AD835E82FB0188','influencerprofile','8C11B342-8002-7D59-D5A2C28158D55B86','influencerprofile',1,'mediakits',2,'{\"object\":\"influencerprofile\",\"objecticonclass\":\"mi-leaf\",\"objectname\":\"\",\"render\":\"server\"}'),('31A2BFDF-8002-7D59-D5A38CA58EADBD96','FD0C308D-916E-4B01-BB35E096E3252B24','influencerSocialMediaStats','8C11B342-8002-7D59-D5A2C28158D55B86','Profile Social Media Stats',1,'mediakits',3,'{\"object\":\"influencerSocialMediaStats\",\"objectname\":\"Profile Social Media Stats\",\"objecticonclass\":\"mi-leaf\",\"inited\":true}'),('31ABFD6F-8002-7D59-D5A1BBE7F0931E90','7CC1C644-A0AF-49E3-A3AD835E82FB0188','influencerprofile','8C11B342-8002-7D59-D5A2C28158D55B86','influencerprofile',1,'mediakits',2,'{\"object\":\"influencerprofile\",\"objecticonclass\":\"mi-leaf\",\"objectname\":\"\",\"render\":\"server\"}'),('31B308E0-8002-7D59-D5A037762B456A40','7CC1C644-A0AF-49E3-A3AD835E82FB0188','influencerprofile','8C11B342-8002-7D59-D5A2C28158D55B86','influencerprofile',1,'mediakits',2,'{\"object\":\"influencerprofile\",\"objecticonclass\":\"mi-leaf\",\"objectname\":\"\",\"render\":\"server\"}'),('31B308E0-8002-7D59-D5A037762B456A40','FAEB8607-62C6-4860-88712314EC894550','influencerSocialMediaStats','8C11B342-8002-7D59-D5A2C28158D55B86','Profile Social Media Stats',1,'mediakits',3,'{\"object\":\"influencerSocialMediaStats\",\"objectname\":\"Profile Social Media Stats\",\"objecticonclass\":\"mi-leaf\",\"inited\":true}'),('59A0F1EE-8002-7D59-D5A2062CB67E6062','2CDFDEF8-1254-48E7-904541B9A7C1E337','LoginForm','C4A96293-8002-7D59-D5A1AB004D42EB01','mediakitsFunctions Influencer login form',1,'mediakits',2,'{\"object\":\"LoginForm\",\"objectname\":\"mediakitsFunctions Influencer login form\",\"objecticonclass\":\"mi-leaf\",\"inited\":true}'),('60E74020-8002-7D59-D5AE2975C2BB449A','61EC36E5-2478-4A22-8A9675DA49AED896','LoginForm','C4A96293-8002-7D59-D5A1AB004D42EB01','mediakitsFunctions Influencer login form',1,'mediakits',2,'{\"object\":\"LoginForm\",\"objectname\":\"mediakitsFunctions Influencer login form\",\"objecticonclass\":\"mi-leaf\",\"inited\":true}'),('629BA833-8002-7D59-D5AD52DD302F7BBA','61EC36E5-2478-4A22-8A9675DA49AED896','LoginForm','C4A96293-8002-7D59-D5A1AB004D42EB01','mediakitsFunctions Influencer login form',1,'mediakits',2,'{\"object\":\"LoginForm\",\"objectname\":\"mediakitsFunctions Influencer login form\",\"objecticonclass\":\"mi-leaf\",\"inited\":true}'),('62C051A3-8002-7D59-D5A44560A6276358','61EC36E5-2478-4A22-8A9675DA49AED896','loginform','C4A96293-8002-7D59-D5A1AB004D42EB01','loginform',1,'mediakits',2,'{\"object\":\"loginform\",\"inited\":\"YES\",\"objecticonclass\":\"mi-leaf\",\"objectname\":\"\",\"render\":\"server\"}'),('63F36AE5-8002-7D59-D5AE48BDF72F70D8','7CC1C644-A0AF-49E3-A3AD835E82FB0188','influencerProfile','8C11B342-8002-7D59-D5A2C28158D55B86','mediakitsFunctions Influencer Profile form',1,'mediakits',2,'{\"object\":\"influencerProfile\",\"objectname\":\"mediakitsFunctions Influencer Profile form\",\"objecticonclass\":\"mi-leaf\"}'),('8B1D998E-8002-7D59-D5AB2363C7014A16','CA4D9B4C-378D-4E4A-88E2A763AF21AC03','influencerSubscribeForm','62BBA162-8002-7D59-D5AD92E0C3ACEEA7','mediakitsFunctions Influencer sub form',1,'mediakits',2,'{\"object\":\"influencerSubscribeForm\",\"objectname\":\"mediakitsFunctions Influencer sub form\",\"objecticonclass\":\"mi-leaf\",\"inited\":true,\"influencersubscribemessage\":\"this si the subform\",\"configureddts\":\"{ts \'2017-10-26 15:02:37\'}\",\"configuredby\":\"User, Admin\"}'),('A4DA1BAC-8002-7D59-D5A9C1A749011681','7CC1C644-A0AF-49E3-A3AD835E82FB0188','influencerprofile','8C11B342-8002-7D59-D5A2C28158D55B86','influencerprofile',1,'mediakits',2,'{\"object\":\"influencerprofile\",\"objecticonclass\":\"mi-leaf\",\"objectname\":\"\",\"render\":\"server\"}'),('B58D068E-8002-7D59-D5A941A4417DF8E9','7CC1C644-A0AF-49E3-A3AD835E82FB0188','influencerProfile','8C11B342-8002-7D59-D5A2C28158D55B86','mediakitsFunctions Influencer Profile form',1,'mediakits',2,'{\"object\":\"influencerProfile\",\"objectname\":\"mediakitsFunctions Influencer Profile form\",\"objecticonclass\":\"mi-leaf\"}'),('B5F5AEF7-8002-7D59-D5A8CFC0CA437FEF','7CC1C644-A0AF-49E3-A3AD835E82FB0188','influencerProfile','8C11B342-8002-7D59-D5A2C28158D55B86','mediakitsFunctions Influencer Profile form',1,'mediakits',2,'{\"object\":\"influencerProfile\",\"objectname\":\"mediakitsFunctions Influencer Profile form\",\"objecticonclass\":\"mi-leaf\"}'),('B913D1A3-8002-7D59-D5A2D76044AEF20D','3B663232-0736-414E-8B985C9C1726A340','twitterupdate','8C11B342-8002-7D59-D5A2C28158D55B86','Profile Twitter Stats',2,'mediakits',2,'{\"object\":\"twitterupdate\",\"objectname\":\"Profile Twitter Stats\",\"objecticonclass\":\"mi-leaf\",\"inited\":true}'),('B913D1A3-8002-7D59-D5A2D76044AEF20D','7CC1C644-A0AF-49E3-A3AD835E82FB0188','influencerprofile','8C11B342-8002-7D59-D5A2C28158D55B86','influencerprofile',1,'mediakits',2,'{\"object\":\"influencerprofile\",\"objecticonclass\":\"mi-leaf\",\"objectname\":\"\",\"render\":\"server\"}'),('B93C8FCC-8002-7D59-D5ABE007F5A3F7C6','3B663232-0736-414E-8B985C9C1726A340','twitterupdate','8C11B342-8002-7D59-D5A2C28158D55B86','twitterupdate',2,'mediakits',2,'{\"object\":\"twitterupdate\",\"inited\":\"YES\",\"objecticonclass\":\"mi-leaf\",\"objectname\":\"\",\"render\":\"server\"}'),('B93C8FCC-8002-7D59-D5ABE007F5A3F7C6','6BB94B49-5F51-4A59-A87630C059B9DD9F','twitterupdate','8C11B342-8002-7D59-D5A2C28158D55B86','Profile Twitter Stats',3,'mediakits',2,'{\"object\":\"twitterupdate\",\"objectname\":\"Profile Twitter Stats\",\"objecticonclass\":\"mi-leaf\",\"inited\":true}'),('B93C8FCC-8002-7D59-D5ABE007F5A3F7C6','7CC1C644-A0AF-49E3-A3AD835E82FB0188','influencerprofile','8C11B342-8002-7D59-D5A2C28158D55B86','influencerprofile',1,'mediakits',2,'{\"object\":\"influencerprofile\",\"objecticonclass\":\"mi-leaf\",\"objectname\":\"\",\"render\":\"server\"}'),('BA071B97-8002-7D59-D5AD912C490DFFD5','6BB94B49-5F51-4A59-A87630C059B9DD9F','twitterupdate','8C11B342-8002-7D59-D5A2C28158D55B86','twitterupdate',2,'mediakits',2,'{\"object\":\"twitterupdate\",\"inited\":\"YES\",\"objecticonclass\":\"mi-leaf\",\"objectname\":\"\",\"render\":\"server\"}'),('BA071B97-8002-7D59-D5AD912C490DFFD5','7CC1C644-A0AF-49E3-A3AD835E82FB0188','influencerprofile','8C11B342-8002-7D59-D5A2C28158D55B86','influencerprofile',1,'mediakits',2,'{\"object\":\"influencerprofile\",\"objecticonclass\":\"mi-leaf\",\"objectname\":\"\",\"render\":\"server\"}'),('BA717274-8002-7D59-D5A84C5216013AEB','7CC1C644-A0AF-49E3-A3AD835E82FB0188','influencerProfile','8C11B342-8002-7D59-D5A2C28158D55B86','mediakitsFunctions Influencer Profile form',1,'mediakits',2,'{\"object\":\"influencerProfile\",\"objectname\":\"mediakitsFunctions Influencer Profile form\",\"objecticonclass\":\"mi-leaf\"}'),('BA885539-8002-7D59-D5AE1972F05BC679','7CC1C644-A0AF-49E3-A3AD835E82FB0188','influencerprofile','8C11B342-8002-7D59-D5A2C28158D55B86','influencerprofile',1,'mediakits',2,'{\"object\":\"influencerprofile\",\"objecticonclass\":\"mi-leaf\",\"objectname\":\"\",\"render\":\"server\"}'),('BA885539-8002-7D59-D5AE1972F05BC679','DE60B68E-EE98-4798-A928B649171D3DFF','twitterupdate','8C11B342-8002-7D59-D5A2C28158D55B86','Profile Twitter Stats',1,'mediakits',3,'{\"object\":\"twitterupdate\",\"objectname\":\"Profile Twitter Stats\",\"objecticonclass\":\"mi-leaf\"}'),('BB56B4A8-8002-7D59-D5AFC14F0239D86E','3522AD66-A9B8-4EB8-B0BFA7F5896C1547','pintrestSetup','BAE2F649-8002-7D59-D5A2CED432CCFFF0','pintrest Setup Form',1,'mediakits',2,'{\"object\":\"pintrestSetup\",\"objectname\":\"pintrest Setup Form\",\"objecticonclass\":\"mi-leaf\",\"inited\":true}'),('C763ED98-AD7D-31D4-2F0068FF79BA2255','61EC36E5-2478-4A22-8A9675DA49AED896','loginform','C4A96293-8002-7D59-D5A1AB004D42EB01','loginform',1,'mediakits',2,'{\"object\":\"loginform\",\"inited\":\"YES\",\"objecticonclass\":\"mi-leaf\",\"objectname\":\"\",\"render\":\"server\"}'),('D7456C4F-8002-7D59-D5A74B13E9C8EC7E','8348A7B9-309A-4BE7-8143C61E22701FE3','twitterupdate','D5B2EBD1-8002-7D59-D5A3153792A7B24E','Twitter Connection Settings',1,'mediakits',2,'{\"object\":\"twitterupdate\",\"objectname\":\"Twitter Connection Settings\",\"objecticonclass\":\"mi-leaf\",\"inited\":true}'),('E968D57E-8002-7D59-D5AEA6B4F2DC5BEE','7CC1C644-A0AF-49E3-A3AD835E82FB0188','influencerprofile','8C11B342-8002-7D59-D5A2C28158D55B86','influencerprofile',1,'mediakits',2,'{\"object\":\"influencerprofile\",\"objecticonclass\":\"mi-leaf\",\"objectname\":\"\",\"render\":\"server\"}'),('E968D57E-8002-7D59-D5AEA6B4F2DC5BEE','C4C9ECBB-9FF9-4B4E-927C31E43C48878D','influencerSocialMediaStats','8C11B342-8002-7D59-D5A2C28158D55B86','Profile Social Media Stats',1,'mediakits',3,'{\"object\":\"influencerSocialMediaStats\",\"objectname\":\"Profile Social Media Stats\",\"objecticonclass\":\"mi-leaf\",\"inited\":true}'),('EA81535F-8002-7D59-D5A41666502FBADB','C5464289-B633-48F9-9E996D1C85EF9A93','generateMiediaKit','EA0A3198-8002-7D59-D5AE99DFA50E107F','Generate Media Kit',1,'mediakits',2,'{\"object\":\"generateMiediaKit\",\"objectname\":\"Generate Media Kit\",\"objecticonclass\":\"mi-leaf\",\"inited\":true}'),('EBB02A80-8002-7D59-D5A3FC641782EB67','7CC1C644-A0AF-49E3-A3AD835E82FB0188','influencerprofile','8C11B342-8002-7D59-D5A2C28158D55B86','influencerprofile',1,'mediakits',2,'{\"object\":\"influencerprofile\",\"objecticonclass\":\"mi-leaf\",\"objectname\":\"\",\"render\":\"server\"}'),('EBB02A80-8002-7D59-D5A3FC641782EB67','7D9BFAE2-7DCF-4B44-AEE189D3EF5E1956','influencerSocialMediaStats','8C11B342-8002-7D59-D5A2C28158D55B86','Profile Social Media Stats',1,'mediakits',3,'{\"object\":\"influencerSocialMediaStats\",\"objectname\":\"Profile Social Media Stats\",\"objecticonclass\":\"mi-leaf\",\"inited\":true