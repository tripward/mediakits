...
CREATE TABLE `custom_accounts` (
  ...
  `Accountsid` char(35) NOT NULL DEFAULT '',
  ...
  KEY `IX_custom_Accounts_siteid` (`siteid`),
  KEY `IX_custom_Accounts_userid` (`userid`)
...
CREATE TABLE `custom_categories` (
  ...
  `influencerid` char(35) DEFAULT '',
  `name` varchar(255) NOT NULL,
  PRIMARY KEY (`categoryid`),
  KEY `IX_custom_categories_influencerid` (`influencerid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `custom_demographics` (
  ...
  `description` varchar(1000) DEFAULT NULL,
  `influencerid` char(35) DEFAULT '',
  `demographicsid` char(35) NOT NULL DEFAULT '',
  `name` varchar(255) NOT NULL,
  PRIMARY KEY (`demographicsid`),
  KEY `IX_custom_demographics_influencerid` (`influencerid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `custom_influencers`
--

DROP TABLE IF EXISTS `custom_influencers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `custom_influencers` (
  `influencerid` char(35) NOT NULL DEFAULT '',
  ...
  `BaseInfluenceRadius` varchar(255) DEFAULT NULL,
  `datemodified` datetime DEFAULT NULL,
...
--
-- Dumping data for table `custom_influencers`
--

LOCK TABLES `custom_influencers` WRITE;
/*!40000 ALTER TABLE `custom_influencers` DISABLE KEYS */;
/*!40000 ALTER TABLE `custom_influencers` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tclusterpeers` VALUES ('77472098-8002-7D59-D5A8344AC7C69E4D'),('785CACFA-8002-7D59-D5A3C1CCBB45CF4B');
...
CREATE TABLE `tuseraddresses` (
  ...
  `addressName` varchar(50) DEFAULT '',
  ...
  `isPrimary` float DEFAULT '0',
  `addressNotes` varchar(50) DEFAULT '',
  `addressURL` varchar(50) DEFAULT '',
  `longitude` float DEFAULT '0',
  `latitude` float DEFAULT '0',
  `addressEmail` varchar(50) DEFAULT '',
  `hours` varchar(50) DEFAULT '',
  `extendDataTable` varchar(50) DEFAULT 'tclassextenddatauseractivity',
  `type` varchar(50) DEFAULT 'Custom',
  `subType` varchar(50) DEFAULT 'Default',
  PRIMARY KEY (`addressID`),
  KEY `Index_2` (`longitude`),
  KEY `Index_3` (`latitude`),
  KEY `Index_4` (`userID`),
  KEY `IX_tuseraddresses_siteID` (`siteID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tuseraddresses` VALUES ('12E09747-8002-7D59-D5AEBE62186DFD87','12D80D2A-8002-7D59-D5A49F4BAB747F70','mediakits','Primary',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,0,0,NULL,NULL,'tclassextenddatauseractivity','Custom','Default'),('12EE3BB3-8002-7D59-D5A46518A4A841AD','12E22ED3-8002-7D59-D5AB9990790141AB','mediakits','Primary',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,0,0,NULL,NULL,'tclassextenddatauseractivity','Custom','Default'),('12FB6B8C-8002-7D59-D5A14772AE4D1D66','12EFB7DE-8002-7D59-D5AAABB1D1E7FBE6','mediakits','Primary',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,0,0,NULL,NULL,'tclassextenddatauseractivity','Custom','Default'),('6EAD0009-8002-7D59-D5AAECDDF3F60C65','6EA4526C-8002-7D59-D5AD89B7260BE84B','mediakits','Primary',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,0,0,NULL,NULL,'tclassextenddatauseractivity','Custom','Default'),('6EB11F5F-8002-7D59-D5AFE6EB097204B2','6EAE9F96-8002-7D59-D5AC60460D092FD8','mediakits','Primary',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,0,0,NULL,NULL,'tclassextenddatauseractivity','Custom','Default'),('6EE50749-8002-7D59-D5A367B0A43FE532','6EDA4F56-8002-7D59-D5A50A1BB6D12038','mediakits','Primary',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,0,0,NULL,NULL,'tclassextenddatauseractivity','Custom','Default');
...
-- Dump completed on 2017-09-16 14:54:25
